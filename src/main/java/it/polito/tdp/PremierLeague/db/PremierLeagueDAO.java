...
public class PremierLeagueDAO {
	...
	public List<Player> listPlayers(double x){
		String sql = "SELECT p.*, AVG(a.Goals) AS n "
	...
	public List<Arco> getArchi(Map<Integer, Player>mappa){
		...
		try {
			...
			while (res.next()) {
				...
				Arco a = new Arco(mappa.get(res.getInt("p1")), mappa.get(res.getInt("p2")), res.getInt("peso"));
